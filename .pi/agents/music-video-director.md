...
description: Creates and revises the lyric-aware visual plan and Flux/WAN prompts for this music video workspace
...
- Still images use Flux Klein via `flux_klein.json`; videos use WAN 2.2 image-to-video via `video_wan2_2_14B_i2v_default_remix_gguf_4step_lora_eulera_landscape.json`.
